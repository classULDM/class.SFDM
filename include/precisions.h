 ...
 */
class_precision_parameter(a_ini_over_a_today_default,double,1.e-14) //1.e-14
/**
 ...
 */
class_precision_parameter(tol_background_integration,double, 1.e-12)//1.e-12)
/**
 ...
 */
class_precision_parameter(tol_shooting_deltax,double,1.e-4)//,1.e-4)
/**
 ...
 */
class_precision_parameter(tol_shooting_deltax_rel,double,1.e-5)//,1.e-5)
/**
 ...
 */
class_precision_parameter(tol_perturbations_integration,double,1.e-7) // 1.e-5
/**
...
class_precision_parameter(k_per_decade_primordial,double,30.0) /**< logarithmic sampling for primordial spectra (number of points per decade in k space) */
